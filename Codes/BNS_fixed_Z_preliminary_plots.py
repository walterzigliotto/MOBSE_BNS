...
def plot_assignment1_fixedZ(dataframe):
    ...
    fig_times, axtimes    = plt.subplots(figsize = (12, 8))
     ...
     #THEY ARE COMMENTED SINCE THEY ARE NOT MORE NECESSARY
...
#     fig_mtot_zoom, axmtot_zoom       = plt.subplots(figsize = (18,12))
    ...
    for fmt, fmt_lab in zip (list_values_fmT, fMT_labels):
        ...
        sns.distplot(subset_data['m1form[8]'], kde = False, label = "fMT"+simul_num, ax = axm1, hist_kws={"histtype": "step", "linewidth" : 2, "alpha" : 0.9}, norm_hist=True)
...
#         sns.distplot(m_tot, kde = False, label = "fMT"+simul_num+"  Z="+metallicity, ax = axmtot_zoom, hist_kws={"histtype": "step"})
        ...
        #plot m_chirp
        sns.distplot(m_chirp, kde = False, label = simul_num, ax = axmchirp, hist_kws={"histtype": "step", "linewidth" : 2, "alpha" : 0.9}, norm_hist=True)

        #plot times
        sns.distplot(subset_data['tmerg[11]'], bins = log_bins,  kde = False , label = simul_num, ax = axtimes, hist_kws={"histtype": "step", "linewidth" : 2, "alpha" : 0.9}, norm_hist=True)

    axm1.set_xlabel("m1 $[M_\odot]$", fontsize = 'xx-large')
    axm1.set_ylabel("Density", fontsize = 'xx-large')
    axm1.set_title("Distribution of m1 for Z = "+met_numb, fontsize = 'xx-large')

    axm2.set_xlabel("m2 $[M_\odot]$", fontsize = 'xx-large')
    axm2.set_ylabel("Density", fontsize = 'xx-large')
    axm2.set_title("Distribution of m2 for Z"+met_numb, fontsize = 'xx-large')

    axmtot.set_xlabel("$m_{tot}$ $[M_\odot]$", fontsize = 'xx-large')
    axmtot.set_ylabel("Density", fontsize = 'xx-large')
    axmtot.set_title("Distribution of $m_{tot} = m_1+m_2$ for Z = "+met_numb, fontsize = 'xx-large')

    axq.set_xlabel("q", fontsize = 'xx-large')
    axq.set_ylabel("Density", fontsize = 'xx-large')
    axq.set_title("Distribution of $q= m_2 / m_1$ for Z = "+met_numb, fontsize = 'xx-large')

    axmchirp.set_xlabel("$m_{chirp}$ $[M_\odot]$", fontsize = 'xx-large')
    axmchirp.set_ylabel("Density", fontsize = 'xx-large')
    axmchirp.set_title("Distribution of $m_{chirp}$ for Z = "+met_numb, fontsize = 'xx-large')
    
#     axm1_zoom.set_xlabel("m1 $[M_\odot]$", fontsize = 'xx-large')
#     axm1_zoom.set_ylabel("Density", fontsize = 'xx-large')
#     axm1_zoom.set_title("Distribution of m1 for Z = "+met_numb, fontsize = 'xx-large') 
...
#     axmtot_zoom.set_title("Distribution of $m_{tot} = m_1+m_2$ for Z = "+met_numb, fontsize = 'xx-large')
#     axmtot_zoom.set_xlim([0,8])

    axtimes.set_xlabel("time delay [Myr]", fontsize = 'xx-large')
    axtimes.set_ylabel("Density", fontsize = 'xx-large')
    axtimes.set_title("Z = "+met_numb, fontsize = 20)
    ...
    axm1.legend(handles=temp_handles, labels=labels, fontsize = 'xx-large', title = 'fMT', title_fontsize = 'xx-large')
    
    handles, labels = axm2.get_legend_handles_labels()
    temp_handles = [Line2D([], [], c=h.get_edgecolor(), linewidth = 2) for h in handles]
    axm2.legend(handles=temp_handles, labels=labels, fontsize = 'xx-large', title = 'fMT', title_fontsize = 'xx-large')
    
    handles, labels = axmtot.get_legend_handles_labels()
    temp_handles = [Line2D([], [], c=h.get_edgecolor(), linewidth = 2) for h in handles]
    axmtot.legend(handles=temp_handles, labels=labels, fontsize = 'xx-large', title = 'fMT', title_fontsize = 'xx-large')
    
    handles, labels = axq.get_legend_handles_labels()   
    temp_handles = [Line2D([], [], c=h.get_edgecolor(), linewidth = 2) for h in handles]
    axq.legend(handles=temp_handles, labels=labels, fontsize = 'xx-large', title = 'fMT', title_fontsize = 'xx-large')

    handles, labels = axmchirp.get_legend_handles_labels()   
    temp_handles = [Line2D([], [], c=h.get_edgecolor(), linewidth = 2) for h in handles]
    axmchirp.legend(loc = 'center left', handles=temp_handles, labels=labels, fontsize = 'xx-large', title = 'fMT', title_fontsize = 'xx-large')
    
    handles, labels = axtimes.get_legend_handles_labels()   
    temp_handles = [Line2D([], [], c=h.get_edgecolor(), linewidth = 2) for h in handles]
    axtimes.legend(loc = 'lower center', handles=temp_handles, labels=labels, fontsize = 'xx-large', title = 'fMT', title_fontsize = 'xx-large')
...
#     axmtot_zoom.tick_params(labelsize = 'xx-large')
    ...
    output_dir = "BNS/fixed_Z/Z"+met_numb
    mkdir_p(output_dir)
