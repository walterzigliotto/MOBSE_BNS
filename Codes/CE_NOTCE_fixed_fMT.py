...
def plot_assignment2(dataframe_CE, dataframe_not_CE):
 ...
 # fig_times, axtimes    = plt.subplots(figsize = (18,12))
    ...
    for metallicity in list_values_met_CE:

        #retrieve only a single metallicity and the string of fmT value
        subset_data_CE = dataframe_CE[dataframe_CE['metallicity'] == metallicity]
        simul_num_CE   = dataframe_CE.iloc[0]['fMT']
    ...
    for metallicity in list_values_met_CE:
        ...
        #retrieve only a single metallicity and the string of fmT value
        subset_data_not_CE = dataframe_not_CE[dataframe_CE['metallicity'] == metallicity]
        simul_num_not_CE   = dataframe_not_CE.iloc[0]['fMT']
...
#     fig_mtot_zoom.show()
    ...
    output_dir = "CE_NOTCE_BNS/fixed_fMT/fMT"+sim_numb_CE
    mkdir_p(output_dir)
